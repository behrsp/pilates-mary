...
import { LogOut, LayoutDashboard, Users, FileVideo, CalendarDays, Share2, Activity, Settings, Info, Heart } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex pb-16 md:pb-0">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-indigo-950/20 border-r border-indigo-900/30 p-6">
        ...
        <nav className="flex-1 space-y-1.5">
          ...
          <Link href="/admin/social" className="flex items-center gap-3 px-4 py-3 rounded-xl text-zinc-400 hover:text-zinc-200 hover:bg-indigo-900/20 transition-all">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-indigo-950/80 backdrop-blur-lg border-t border-indigo-900/50 z-50 px-4 py-3 flex justify-between items-center pb-safe overflow-x-auto gap-2">
        ...
        <Link href="/admin/social" className="flex flex-col items-center gap-1 text-zinc-400 hover:text-zinc-200 min-w-[60px]">
          <Heart className="w-5 h-5" />
